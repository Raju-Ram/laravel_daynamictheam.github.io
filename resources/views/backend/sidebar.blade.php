        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{url('/adduser')}}">Add</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{url('/showuserlist')}}">LIST</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{url('/edituserlist')}}">EDIT</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            ...
            <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{url('addbanner')}}">Add</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{url('/showbannerlist')}}">LIST</a></li>
          ...
          <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="#charts" aria-expanded="false" aria-controls="charts">
              ...
              <span class="menu-title">CMC</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="charts">
            <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{url('addcmc')}}">Add</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{url('showcmclist')}}">LIST</a></li>
                <li class="nav-item"> <a class="nav-link" href="pages/ui-features/typography.html">EDIT</a></li>
              </ul>
            </div>
          </li>
